...
const initialItems = [
  ...
  },
  {
    ...
    name: "Chicken Karahi",
    description:
      "Traditional chicken curry cooked in wok with tomatoes and spices",
    price: 1200,
    image: karahi,
  },
  {
  ...
  },
  {
    id: 8,
    name: "Kulfi",
    description: "Pakistani ice cream with cardamom & pistachios",
    price: 300,
    image: kulfi,
  },
  {
    id: 9,
    name: "Lassi",
    description: "Yogurt drink - sweet/salty",
    price: 250,
    image: lassi,
  },
  {
    id: 10,
    name: "Kashmiri Chai",
    description: "Pink tea with cardamom, cinnamon and almonds",
    price: 200,
    image: chai,
  },
].map((i) => ({ ...i, quantity: 0 }));
...
export default function Orders() {
  ...
  const recommended = useMemo(() => {
    ...
    const matches = items.filter(
      (i) => i.name.toLowerCase().includes(key) && i.id !== last.id
    );
